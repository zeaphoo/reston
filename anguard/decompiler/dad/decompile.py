...
from anguard.decompiler.dad.ast import (
    ...
    dummy)
from anguard.decompiler.dad.control_flow import identify_structures
from anguard.decompiler.dad.dataflow import (
    build_def_use, place_declarations, dead_code_elimination,
    register_propagation, split_variables)
from anguard.decompiler.dad.graph import construct, simplify, split_if_nodes
from anguard.decompiler.dad.instruction import Param, ThisParam
from anguard.decompiler.dad.writer import Writer
...
def main():
    ...
    default_file = 'examples/android/TestsAnguard/bin/TestActivity.apk'
    if len(sys.argv) > 1:
