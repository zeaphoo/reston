...
from anguard.decompiler.dad.util import get_type
from anguard.decompiler.dad.opcode_ins import Op
from anguard.decompiler.dad.instruction import (
...
class Writer(object):
    ...
    # ('METHOD', 'sendToServer', 'this -> sendToServer', <anguard.decompiler.dad.instruction.ThisParam>)
