...
# Init Logger
log_andro = logging.getLogger("anguard")

console_handler = logging.StreamHandler()
console_handler.setFormatter(logging.Formatter("%(levelname)s: %(message)s"))
log_andro.addHandler(console_handler)
log_runtime = logging.getLogger("anguard.runtime")  # logs at runtime
log_interactive = logging.getLogger("anguard.interactive")  # logs in interactive functions
log_loading = logging.getLogger("anguard.loading")  # logs when loading andro
