...
# Init Logger
log_andro = logging.getLogger("reston")

console_handler = logging.StreamHandler()
console_handler.setFormatter(logging.Formatter("%(levelname)s: %(message)s"))
log_andro.addHandler(console_handler)
log_runtime = logging.getLogger("reston.runtime")  # logs at runtime
log_interactive = logging.getLogger("reston.interactive")  # logs in interactive functions
log_loading = logging.getLogger("reston.loading")  # logs when loading andro
