...
from reston.decompiler.dad.util import get_type
from reston.decompiler.dad.opcode_ins import Op
from reston.decompiler.dad.instruction import (
...
class Writer(object):
    ...
    # ('METHOD', 'sendToServer', 'this -> sendToServer', <reston.decompiler.dad.instruction.ThisParam>)
